...
RUN SOLR_HOME=/build/solr IMPORT_ON_INVALID=${ON_INVALID} java -cp "/opt/solr/server/solr-webapp/webapp/WEB-INF/lib/*:/opt/solr/server/lib/*:/opt/solr/server/lib/ext/*:/build/lib/*" \
